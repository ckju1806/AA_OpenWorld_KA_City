# Werkzeug-Inventar (Entwicklungsumgebung 2026-09-23)

| Werkzeug | Status | Zweck |
|---|---|---|
| Godot 4.7.2-stable (Linux x86_64) | installiert, SHA512 geprüft | Import, Tests, Export |
| Windows-x64-Export-Templates 4.7.2 | installiert, SHA512 geprüft | Windows-Export |
| Xvfb | vorhanden | virtuelles Display für Screenshots |
